 ...
 * thrown by the {@code getLowerDifference} when the arguments are invalid.
 * <p>
 ...
 */
public final class TestExceptionLowerDifference {

    /**
     * Default constructor.
     */
    public TestExceptionLowerDifference() {
        super();
    }

    /**
     * Tests that an {@code IllegalArgumentException} is thrown when an interval
     * is invalid.
     */
    @Test(expectedExceptions = IllegalArgumentException.class)
    public final void testLowerDifference_InvalidInterval() {
     ...
     */
    @Test(expectedExceptions = IllegalArgumentException.class)
    public final void testLowerDifference_NotOverlapped() {
        final Interval intervalA; // Interval for testing
        final Interval intervalB; // Interval for testing
        ...
        Mockito.when(intervalB.getLowerLimit()).thenReturn(15);
        Mockito.when(intervalB.getUpperLimit()).thenReturn(20);
     ...
     * intervals have the same lower limit.
     */
    @Test(expectedExceptions = IllegalArgumentException.class)
    public final void testLowerDifference_SameLowerLimit() {
        final Interval intervalA; // Interval for testing
        final Interval intervalB; // Interval for testing
