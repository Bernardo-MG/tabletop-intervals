 ...
 * {@code isRightAfter} method works as expected.
 * <p>
 * Checks the following cases:
 * <ol>
 * <li>An interval right after is recognized as such.</li>
 * <li>An interval not right after is recognized as such.</li>
 * </ol>
 * 
 * @author Bernardo Martínez Garrido
 */
public final class TestIsRightAfter {

    /**
     * Default constructor.
     */
    public TestIsRightAfter() {
        super();
    }

    /**
     * Tests that an interval not right after is recognized as such.
     */
    @Test
    public final void testIsRightAfter_NotRightAfter() {
    ...
    /**
     * Tests that an interval right after is recognized as such.
     */
    @Test
    public final void testIsRightAfter_RightAfter() {
        final Interval intervalA; // Interval for testing
        final Interval intervalB; // Interval for testing
